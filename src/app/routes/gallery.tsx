    ...
    <article className="container mx-auto pt-12 md:pt-20 pb-24 px-6">
      ...
      {galleries.length === 0 ? (
        ...
        <div className="columns-1 md:columns-2 lg:columns-3 gap-4 space-y-4">
          {visibleGalleries.map((gallery: any, galleryIndex: number) => {
        ...
        {visibleCount < galleries.length && (
          <div className="flex justify-center mt-10">
            <button
              ...
              className="font-mono text-sm px-5 py-3 border border-zinc-700 rounded-xl text-zinc-300 hover:bg-zinc-900 transition-all">
              Load More
            </button>
          </div>
        )}
