  ...
  return (
    <div
      ...
      {images.length > 1 && (
        <>
          <button
            className="absolute left-6 md:left-[22%] top-1/2 z-20 -translate-y-1/2 rounded-full bg-black/40 px-4 py-2 text-4xl text-white hover:bg-black/70 transition-all"
            onClick={e => {
              e.stopPropagation()
              prev()
            }}>
          ...
          <button
            className="absolute right-6 md:right-[22%] top-1/2 z-20 -translate-y-1/2 rounded-full bg-black/40 px-4 py-2 text-4xl text-white hover:bg-black/70 transition-all"
            onClick={e => {
              e.stopPropagation()
              next()
            }}>
