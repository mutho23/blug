  ...
  return (
    <div
      ...
      {images.length > 1 && (
        <>
          <button
            className="absolute left-4 top-1/2 z-20 -translate-y-1/2 rounded-full bg-black/40 px-4 py-2 text-4xl text-white hover:bg-black/70"
            onClick={e => {
              e.stopPropagation()
              prev()
            }}>
          ...
          <button
            className="absolute right-4 top-1/2 z-20 -translate-y-1/2 rounded-full bg-black/40 px-4 py-2 text-4xl text-white hover:bg-black/70"
            onClick={e => {
              e.stopPropagation()
              next()
            }}>
