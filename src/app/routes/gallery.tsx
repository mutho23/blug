...
function Lightbox({
  ...
  useEffect(() => {
    ...
    new Image().src = images[(index + 1) % images.length].url
    new Image().src = images[(index - 1 + images.length) % images.length].url
  }, [index, images])
...
function MasonryGrid({
  ...
  // 3+ foto: pasangkan dulu, foto terakhir (jika ganjil) full-width di bawah
