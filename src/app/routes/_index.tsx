  ...
  return (
    <li>
      <div
        ...
        className="group flex gap-4 py-5 -mx-3 px-3 rounded-md transition-colors hover:bg-zinc-950 cursor-pointer">
        ...
        <div className="flex flex-col gap-1.5 min-w-0 w-full">
          <div className="flex items-baseline justify-between gap-3 flex-wrap">
            ...
            <span className={`font-mono text-xs text-zinc-600 transition-transform duration-200 flex-shrink-0 ${expanded ? 'rotate-180' : ''}`}>
              ▼
            </span>
          </div>
          ...
          {expanded && (
            <div className="mt-1 space-y-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-1 font-mono text-xs text-zinc-600 hover:text-[#5EA2FF] transition-colors">
                Lihat di Popfeed ↗
              </a>
            </div>
          )}
