      ...
      <section>
        ...
        {allTags.length > 0 && (
          <div className="relative inline-block mb-8">
            ...
            {/* DROPDOWN */}
            {showTags && (
              <div className="absolute left-0 top-full mt-4 w-[300px] rounded-[28px] border border-zinc-800 bg-[#0A0A0A] p-4 shadow-2xl z-50">
                {/* ALL POSTS */}
                <button
                  onClick={() => {
                    setActiveTag(null)
                  ...
                  className={`w-full text-left px-6 py-5 rounded-[22px] text-[18px] transition-all ${
                    activeTag === null
                ...
                <div className="mt-2 flex flex-col">
                  {allTags.map(tag => (
                    <button
                      ...
                      className={`w-full text-left px-6 py-4 rounded-[22px] text-[18px] transition-all ${
                        activeTag === tag
                          ? 'bg-[#69A7F5] text-black'
                          : 'text-zinc-300 hover:bg-zinc-900 hover:text-white'
                      }`}>
